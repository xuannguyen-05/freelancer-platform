...
- ✅ Complex relationships (References)
...
**Live API Docs:** `GET http://localhost:8888/api-docs`

Swagger UI cung cấp:
- 📖 Chi tiết tất cả endpoints
- 📝 Request/Response examples
- 🧪 Try it out - Test API trực tiếp
- 🔐 Authorization - JWT token testing

---

**Được xây dựng với ❤️ cho cộng đồng freelancer**

*Phiên bản: 1.0.0 | Created: May 2026*
...
- `GET /api/contracts/:id/progress-finance`
...
Custom query/report endpoints:
- `GET /api/contracts/projects-over-order`
  - Query projects where total contract budget is greater than order total
- `GET /api/tasks/overdue-open`
  - Query overdue tasks that are not finished

## 8) Role Notes

- Buyer: creates project/contract, pays and reviews outcomes
- Primary freelancer (contract lead): plans tasks, assigns team members
- Freelancer member: updates assigned task progress
- Admin: system-level management and admin reports

## 9) Current Status

Implemented and stabilized:
- Prisma -> Mongoose migration for core business modules
- Contract-task-project relationship redesign
- Effort-based progress tracking
- Hourly payable-by-worklog behavior
- Over-budget and overdue reporting endpoints

## 10) Future Improvements

- Add automated tests (unit + integration)
- Add CI pipeline (lint/test/build)
- Add richer audit trail for business events
- Improve dashboard analytics endpoints
